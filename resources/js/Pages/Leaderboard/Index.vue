            ...
            <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                <div v-for="(user, index) in leaderboard" :key="user.id" 
                    ...
                    <div class="flex items-center gap-3 sm:gap-6 flex-1 min-w-0">
                        ...
                        <div class="w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center text-xs sm:text-sm font-bold text-gray-500 bg-gray-200 border border-gray-100 overflow-hidden shrink-0">
