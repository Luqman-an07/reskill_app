    ...
    <div class="relative">
        ...
        <Teleport to="body">
            ...
            <div class="px-6 py-4 border-b border-gray-50 bg-gray-50/50 text-center">
                <div class="w-16 h-16 rounded-full bg-blue-100 text-blue-700 flex items-center justify-center text-xl font-bold mx-auto mb-2 overflow-hidden border-2 border-white shadow-sm">
